    ...
    <>
      <div className="flex items-center gap-2 pointer-events-auto relative">
        <button
          ...
          className={`px-3 h-9 flex items-center gap-2 rounded-lg border transition-colors shadow-sm whitespace-nowrap shrink-0 ${showNotes ? 'bg-[#3B82F6]/20 border-[#3B82F6] text-[#3B82F6]' : 'bg-[#0F172A] border-[#1E293B] text-[#94A3B8] hover:text-[#F1F5F9] hover:bg-[#1E293B]'}`}
          title="Design Notes"
        >
